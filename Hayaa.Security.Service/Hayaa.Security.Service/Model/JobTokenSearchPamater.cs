...
///代码效率工具生成，此文件不要修改
/// </summary>
namespace Hayaa.Security.Service{public class JobTokenSearchPamater:SearchPamaterMariadbBase {public int? JobTokenId{set;get;}
...
private String GetJobTokenIdSqlForSharp(){String sql = "";switch (JobTokenIdPOT){
...
private String GetEndTimeSqlForSharp(){String sql = "";switch (EndTimePOT){
